 ...
 */
abstract class UsernameTokenConverter implements ParamConverterInterface
{
    private $registry;
    ...
    public function apply(Request $request, ParamConverter $configuration)
    {
        ...
        $user = $this->findUser($userRepository, $username, $rssToken);
     ...
     * @return User
     */
    protected abstract function findUser(UserRepository $userRepository, $username, $token);
}
